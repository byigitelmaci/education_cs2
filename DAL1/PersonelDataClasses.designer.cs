...
namespace DAL1
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="PERSONEL_TAKIPP")]
    ...
    partial void InsertMAASST(MAASST instance);
    partial void UpdateMAASST(MAASST instance);
    partial void DeleteMAASST(MAASST instance);
    #endregion
		
		public PersonelDataClassesDataContext() : 
				base(global::DAL1.Properties.Settings.Default.PERSONEL_TAKIPPConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<MAASST> MAASSTs
		{
			get
			{
				return this.GetTable<MAASST>();
			}
		}
	}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.MAASST")]
	public partial class MAASST : INotifyPropertyChanging, INotifyPropertyChanged
	{
