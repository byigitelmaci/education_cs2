...
namespace DAL_
{
    ...
    partial void DeletePOZİSYON(POZİSYON instance);
		...
		public PersonelDataClassesDataContext() : 
				base(global::DAL_.Properties.Settings.Default.personel_takipConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnDepartmanIDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="DepartmanAd", Storage="_DepartmanAd", DbType="Int NOT NULL")]
		public int DepartmanID
		{
			get
			{
